  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-[1000] w-full px-6 py-4 flex items-center justify-between ${glassPanel}`}>
      ...
      <div className="hidden md:flex items-center gap-8 text-xs font-semibold tracking-[0.15em] uppercase text-slate-400">
        ...
        <Link to="/path-planner" className="hover:text-cyan-400 transition-colors">Path Planner</Link>
      ...
      <button onClick={() => navigate('/path-planner')} className="md:hidden relative group px-4 py-2 rounded-lg text-[10px] font-bold uppercase tracking-wider text-teal-400 border border-teal-500/30 bg-teal-500/10 hover:bg-teal-500/20 transition-all">
        Menu
      </button>
